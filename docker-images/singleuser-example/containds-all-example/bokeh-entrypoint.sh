...
jhsingle-native-proxy --destport 0 --authtype oauth bokeh-root-cmd "$notebook" {--}port={port} {--}allow-websocket-origin={origin_host} --ready-check-path=/ready-check --port $port
