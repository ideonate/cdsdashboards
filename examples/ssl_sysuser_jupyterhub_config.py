...
c.DockerSpawner.image = 'jh-voila-oauth-singleuser:singleuser-1.2' # 'ideonate/jh-voila-oauth-scipy:latest'
...
#c.DockerSpawner.volumes = { '/Users/dan/Dev/sysjupyter/jupyter-{username}': notebook_dir }
